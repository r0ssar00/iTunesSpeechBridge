...
namespace RCF {
    ...
    public:
        ...
        void uploadFile(Token & token, const std::string & whichFile, boost::uint32_t chunkSize = 8*1024);
        void downloadFile(Token token, const std::string & whichFile, boost::uint32_t chunkSize = 8*1024, bool resumeExisting = false);

        void uploadFile(const std::string & whichFile, boost::uint32_t chunkSize = 8*1024);
        void downloadFile(const std::string & whichFile, boost::uint32_t chunkSize = 8*1024, bool resumeExisting = false);



        void uploadFile(Token * pToken, const std::string & whichFile, boost::uint32_t chunkSize);
        void downloadFile(Token * pToken, const std::string & whichFile, boost::uint32_t chunkSize, bool resumeExisting);
