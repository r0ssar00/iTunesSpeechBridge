...
namespace SF {
    ...
    class RCF_EXPORT I_ContextRead
    {
    public:
    ...
    class RCF_EXPORT I_ContextWrite
    {
    public:
    ...
    class RCF_EXPORT I_WithContextRead
    {
    public:
    ...
    class RCF_EXPORT I_WithContextWrite
    {
    public:
    ...
    class RCF_EXPORT I_LocalStorage
    {
    public:
    ...
    class RCF_EXPORT I_WithLocalStorage
    {
    public:
    ...
    class RCF_EXPORT I_WithEncoding
    {
    public:
    ...
    class RCF_EXPORT I_Stream
    {
    public:
        virtual ~I_Stream() {}
    };

    class RCF_EXPORT WithFormatWrite
    {
    public:
    ...
    class RCF_EXPORT WithFormatRead
    {
    public:
