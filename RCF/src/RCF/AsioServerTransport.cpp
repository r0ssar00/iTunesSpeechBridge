...
namespace RCF {
    ...
    private:
            ...
            int error)
        {
            ...
            mSessionState.onReadWrite(byteBuffer.getLength(), ec);
        }
            ...
            int error)
        {
            ...
            mSessionState.onReadWrite(bytesTransferred, ec);
        }
        ...
        if (!error && !mTransport.mStopFlag)
        {
            ...
            else
            {
                ...
                mTransportFilters.empty() ?
                    onReadWrite(bytesTransferred, ec) : 
                    mTransportFilters.back()->onReadCompleted(mTempByteBuffer, 0);
            }
        }
    }
