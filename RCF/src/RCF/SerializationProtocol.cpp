...
namespace RCF {
    ...
    void SerializationProtocolIn::bindProtocol()
    {
        ...
        switch (mProtocol)
        {
        case 1: mInProtocol1.bind(*mIsPtr, archiveLength); break;
        case 2: mInProtocol2.bind(*mIsPtr, archiveLength); break;
        case 3: mInProtocol3.bind(*mIsPtr, archiveLength); break;
        case 4: mInProtocol4.bind(*mIsPtr, archiveLength); break;
        case 5: mInProtocol5.bind(*mIsPtr, archiveLength); break;
...
#define for if (0) {} else for
        ...
        ByteBuffer byteBuffer)
    {
        ...
        {
            mOsPtr->write(byteBuffer.getPtr(), byteBuffer.getLength());
        }
...
#undef for
    ...
    void SerializationProtocolOut::bindProtocol()
    {
        ...
        case 5: mOutProtocol5.bind(*mOsPtr); break;
        default: RCF_ASSERT(0)(mProtocol);
        }
    }
