...
namespace RCF {
            ...
            mpSec(RCF_DEFAULT_INIT)
    {
        ...
        RCF_VERIFY( hEvent, Exception(RcfError_Pipe, dwErr));
        ...
        unsigned int timeoutMs)
    {
        ...
        {
            RCF_THROW(Exception(RcfError_ClientConnectTimeout))(timeoutMs);
        }
        else
        {
            mhPipe = hPipe;
        ...
        std::size_t bytesRequested)
    {
        ...
        if (!ok)
        {
            RCF_VERIFY( 
                ...
                Exception(RcfError_ClientReadFail, dwErr));
        }
        ...
        dwErr = GetLastError();
        RCF_VERIFY(ok && dwRead > 0, Exception(RcfError_Pipe, dwErr));
        ...
        const std::vector<ByteBuffer> &byteBuffers)
    {
        ...
        RCF_VERIFY(ok, Exception(RcfError_ClientWriteFail, dwErr));
